...
,CASE
    ...
    WHEN DT_PEDIDO_RX IS NOT NULL AND DH_PED_LAB IS NULL AND HR_SOLSAI_PRO IS NULL THEN ROUND(((SYSDATE - DT_PEDIDO_RX)*24 *60),0) END AS TEMPO_8
...
FROM (
    SELECT 
        ...
        A.CD_ATENDIMENTO,
        MIN( LAU.DT_STUDY) AS DH_CAPTURA,
