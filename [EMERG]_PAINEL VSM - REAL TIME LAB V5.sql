...
, ROUND(((NVL(NVL(MAX(DH_BANCADA),NVL((SELECT MAX(DH_FECHAMENTO) FROM DBAMV.PW_DOCUMENTO_CLINICO
                                        WHERE CD_ATENDIMENTO = BASE.CD_ATENDIMENTO AND CD_TIPO_DOCUMENTO = 12),DT_ALTA_MEDICA)),SYSDATE) - MAX (DH_CONFIRMA_LAB))*24 *60),0) AS TEMPO_22
