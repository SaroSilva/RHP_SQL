...
FROM
    (
        ...
        AND FLOW_BOT_API_PHONE IN ('558182101070','558181825449','558199716404','5581988582271','558186244420','558186463640','558187092879','558187576567','558187728695') --veriicar instabilidades de disparo
        --AND STATE_ = 'ACTIVE'
        AND FLOW_BOT_API_PHONE NOT IN ('5581')
        AND FLOW_BOT_API_PHONE NOT LIKE '55813%'
        AND TRUNC (START_TIME_) = TO_DATE ('04/04/2024','DD/MM/YYYY')
order by FLOW_BOT_API_PHONE, AHP.START_TIME_ DESC , AHP.END_TIME_ desc
