...
AND CD_REGISTRO_OCORRENCIA = 32076
ORDER BY RO.DT_REGISTRO asc
;
SELECT * FROM ALL_TAB_COLUMNS
WHERE OWNER = 'DBAPORTAL'
AND COLUMN_NAME LIKE '%GRAU_NEA%'
--AND TABLE_NAME LIKE '%TP_GRAU_NEA%'
ORDER BY 2,3
;
SELECT * FROM DBAPORTAL.PREFERENCIA_OCORRENCIA 
WHERE UPPER (DS_PESSOA) LIKE '%TP_GRAU_NEA%'
--AND CD_OCORRENCIA = 242
--AND CD_REGISTRO_OCORRENCIA = 54109
;
SELECT * FROM DBAPORTAL.REGISTRO_OCORRENCIA
WHERE CD_REGISTRO_OCORRENCIA = 32076
--45904 -- GRAU SENTINELA